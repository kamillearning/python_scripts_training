...
number_from = int(input("Specify the value from which you want to create an array: "))
number_to = int(input("Specify the value on which you want to end the array: "))
